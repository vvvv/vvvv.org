...
author: "pixel.forest()"
date: "2026-04-08"
title: "Workshop: Interactive Particle Systems in vvvv"
description: "A two-day workshop at pixel.forest() Berlin led by Rosi Grillmair, covering the basics of VL.Fuse"
where: 
...
In the end, we will make sure that signed distance fields, delegates and particle indices will be more than words, rather tools you can work with to create your own interactive artworks.

{{< box >}}
Tickets starting at 60€ - [**sign up here!**](https://pixel-forest.com/workshops/interactive-particle-systems-in-vvvv-with-rosi-grillmair/)
{{< /box >}}

[![](fuse-pixelforest.png)](https://pixel-forest.com/workshops/interactive-particle-systems-in-vvvv-with-rosi-grillmair/)