...
But a few things still happened towards the end, one of which we can already share:
...
- There's a new release for [Gamma Launcher](https://github.com/sebescudie/GammaLauncher/releases) by [sebescudie](https://vvvv.org/people/sebescudie)

## Open calls
Two open calls that may interest you:
- Deadline January 11: [Call for AV performers](https://vvvv.org/blog/2026/open-call-for-av-performers-for-avjam/) by [The Node Institute](https://thenodeinstitute.org/)
- Deadline January 31: [Call for site-specific audiovisual artwork](https://tally.so/r/ODlNep) as mentioned by [StiX](https://vvvv.org/people/StiX)
...
- [VL.CoreLib.Addons](https://www.nuget.org/packages/VL.CoreLib.Addons)
...
つづく - Tsuzuku by [f3.studio](https://www.youtube.com/channel/UCBpgxLZkGYDEUTqvtmwmfYA)
