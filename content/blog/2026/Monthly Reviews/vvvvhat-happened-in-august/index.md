---
date: "2026-09-08"
title: "vvvvhat happened in August 2026"
...
A bit special interest, but vvvv finally supports [stereoscopic rendering](https://vvvv.org/blog/2026/introducing-support-for-stereoscopic-rendering/), which is really cool if you have the required hardware at hand.

And even more special interest, triggered by the above, we've released [VL.DeepSpace](https://vvvv.org/blog/2026/introducing-vl.deepspace/). A pack to get you started developing applications for the Ars Electronica Deep Space.

In our quest to offer support for a wide range of motion capture systems for avateering, we've added [VL.Captury](https://vvvv.org/blog/2026/introducing-support-for-captury/). 

Further we can report more progress on the Package Manager that should soon be ready for a merge to previews. And also we're finally continuing work on full support for the latest Orbbec depth cameras. Bare with us... 

## vvvv at Ars Electronica 2026

This time of the year again. Meet your fellow patchers IRL:
...
[The NODE Institute's](https://thenodeinstitute.org/) winter season of vvvv courses is live. Check these:

Beginners start here:
- [Part I: Playful Patching in vvv gamma](https://thenodeinstitute.org/courses/vvvv-beginner-class-part1-winter-2026?utm_source=vvvv&utm_medium=blog) from October 19
- [Part II: Foundations of VL Development](https://thenodeinstitute.org/courses/vvvv-beginner-class-part2-winter-2026?utm_source=vvvv&utm_medium=blog) from January 11 
- **[Many more live courses](https://thenodeinstitute.org/learning-vvvv/?v=7d0db380a5b9#winter)** on a wide range of topics
...
We have 3 new ones:
- [VL.Captury](https://www.nuget.org/packages/VL.Captury)
- [VL.DeepSpace](https://www.nuget.org/packages/VL.DeepSpace)
- [VL.HardwareMonitor](https://www.nuget.org/packages/VL.HardwareMonitor)
...
<video width=100% controls autoplay>
    <source src="https://wirmachenbunt.de/media/pages/work/expo-osaka/87052f5c8f-1779471557/videoexpo.mp4" type="video/mp4">
    Your browser does not support the video tag.  
</video>

[EXPO OSAKA: German Pavillion](https://wirmachenbunt.de/work/expo-osaka) by [wirmachenbunt](https://wirmachenbunt.de/).
