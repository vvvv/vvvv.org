...
While vvvv is a visual-first development environment, you can also choose to [write parts of your apps using C#](../Extendability/). vvvv's visual language VL is best at high/mid-level organization of code while text-code often excells at implementing fine-grained algorithms. The key is finding the right balance for yourself, which vvvv allows you to do. 
